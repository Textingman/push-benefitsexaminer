          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <a
                  href="mailto:support@benefitsexaminer.com"
              ...
              <div>
                ...
                <p style={{ color: '#6B7280' }}>
                  Benefits Examiner<br />
                  6106 Cherrylawn Cir<br />
                  Austin, TX 78723
                </p>
              </div>
              ...
              <div>
                ...
                <p style={{ color: '#6B7280' }}>
                  ...
                  <a href="mailto:support@benefitsexaminer.com" className="font-medium hover:underline" style={{ color: '#7C3AED' }}>
                    support@benefitsexaminer.com
                  </a>.
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: '#6B7280' }}>
                  Reply <strong>HELP</strong> to any SMS message or email us at support@benefitsexaminer.com.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: '#6B7280' }}>
                  ...
                  <a href="/privacy" className="font-medium hover:underline" style={{ color: '#7C3AED' }}>Privacy Policy</a> for full details.
                </p>
              </div>
