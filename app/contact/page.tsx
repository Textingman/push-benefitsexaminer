            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  style={{ backgroundColor: submitting ? '#9CA3AF' : '#7C3AED', cursor: submitting ? 'not-allowed' : 'pointer' }}
                >
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@benefitsexaminer.com" className="text-base font-medium hover:underline" style={{ color: '#7C3AED' }}>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#6B7280' }}>
                    ...
                    <a href="/privacy" className="font-medium hover:underline" style={{ color: '#7C3AED' }}>Privacy Policy</a>.
                  </p>
                </div>
                <div>
